 ...
 */
public enum Tool {
    WATER(null, new Color(0.32f, 0.55f, 0.85f, 1f)),
    SEED_GRASS(Plant.GRASS, new Color(0.49f, 0.78f, 0.31f, 1f)),
    SEED_TREE(Plant.TREE, new Color(0.18f, 0.47f, 0.24f, 1f)),
    SEED_FLOWER(Plant.FLOWER, new Color(0.86f, 0.35f, 0.62f, 1f)),
    ROCK(null, new Color(0.50f, 0.50f, 0.53f, 1f));

    /** The seed this tool plants, or null for non-planting tools. */
    public final Plant seed;
    public final Color swatch;

    Tool(Plant seed, Color swatch) {
        this.seed = seed;
        this.swatch = swatch;
    }
}
